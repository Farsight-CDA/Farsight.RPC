...
internal sealed class RealtimeRpcEFConfiguration : IEntityTypeConfiguration<RealtimeRpc>
{
    public void Configure(EntityTypeBuilder<RealtimeRpc> entity)
    {
