import { createComponent, isServer, ssr, ssrHydrationKey, escape, getRequestEvent, delegateEvents, ssrElement, mergeProps as mergeProps$1 } from 'solid-js/web';
import { C as Ct$1 } from '../nitro/nitro.mjs';
import { Suspense, createSignal, onMount, onCleanup, Show, mergeProps, splitProps, createMemo, children, getOwner, sharedConfig, useContext, createRenderEffect, on, runWithOwner, createContext, untrack, createRoot, startTransition, resetErrorBoundaries, batch, createComponent as createComponent$1 } from 'solid-js';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
